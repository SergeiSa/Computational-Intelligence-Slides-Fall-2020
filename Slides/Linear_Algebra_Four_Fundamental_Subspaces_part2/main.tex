...
\begin{equation}
    \mathbf{A} \mathbf{x}^* + \mathbf{B}_1 \mathbf{u}^**_1 + \mathbf{B}_2 \mathbf{u}^0_2 = \mathbf{0}
\end{equation}
%
where $\mathbf{u}^**_1 = \mathbf{u}^*_1 + \mathbf{B}^+_1 \mathbf{a}$.
