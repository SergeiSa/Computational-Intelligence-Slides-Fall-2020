...
V2_relaxed = con2vert(A2, b2+bigM)';
indices_convhull = convhull(V2_relaxed');
V2_relaxed = V2_relaxed(:, indices_convhull);
...
plot(V2_relaxed(1, :)', V2_relaxed(2, :)', 'o', 'MarkerFaceColor', 'g'); hold on;
graphic.h3 = fill(V2_relaxed(1, :)', V2_relaxed(2, :)', [0.8, 0.8, 0], 'FaceAlpha', '0.1'); hold on;


axis equal;
legend([graphic.h1, graphic.h2, graphic.h3], 'V1', 'V2', 'V2 relaxed')